...
- **Observer** - события DataChanged / StatusChanged в контроллерах для оповещения UI
- **Factory Method** - ReportFactory создает отчеты по выбранному типу
- **Strategy** - стратегии фильтрации остатков
- **Memento** - отмена ранее проведенного документа с откатом остатков
...
Комаричева Ирина Романовна, группа ИСС-32
